            ...
            d = l.getAttribute("name")) {
                ...
                function(e, c) {
                    e.addEventListener("scroll", e.syn = function() {
                        var l, u, d = s[c], f = e[i + r], h = e[i + o], p = f / (e[i + t] - e[a + t]), m = h / (e[i + n] - e[a + n]), v = 0, E = 0;
                        for (f != e.eX && (v = 1,
                        e.eX = f),
                        h != e.eY && (E = 1,
                        e.eY = h),
                        u = 0; u < d.length; u++)
                            l = d[u],
                            l != e && (v && (f = Math.round(p * (l[i + t] - l[a + t])),
                            l.eX = l[i + r] = f),
                            E && (h = Math.round(m * (l[i + n] - l[a + n])),
                            l.eY = l[i + o] = h))
                    }
                    , 0)
                }(l, d)
...
function() {
    ...
    Timetable.Renderer.prototype = {
        draw: function(e) {
            ...
            function d(e, t) {
                var n, o, r, i = void 0 !== e.options, a = !1;
                i && (n = void 0 !== e.options.url,
